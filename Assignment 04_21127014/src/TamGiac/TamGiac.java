...
public class TamGiac {
    ...
    double tongChuVi(List<TamGiac> listTG) {
        double sumChuVi = 0.0;
    ...
    TamGiac maxChuViTamGiac(List<TamGiac> listTG) {
    ...
    TamGiac minChuViTamGiac(List<TamGiac> listTG) {
        TamGiac tmp = new TamGiac();
    ...
    void listTamGiac(List<TamGiac> listTG){
    ...
    void chuViTGLessX(List<TamGiac> listTG, double x) {
    ...
    void trongTamInList(List<TamGiac> listTG){
